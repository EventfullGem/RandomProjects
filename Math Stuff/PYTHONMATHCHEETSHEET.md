...
- [math-as-code (Python version)](#math-as-code-python-version)
- [foreword](#foreword)
- [contents](#contents)
  ...
  - [common number sets](#common-number-sets)
      - [`ℝ` real numbers](#ℝ-real-numbers)
      - [`ℚ` rational numbers](#ℚ-rational-numbers)
      - [`ℤ` integers](#ℤ-integers)
      - [`ℕ` natural numbers](#ℕ-natural-numbers)
      - [`ℂ` complex numbers](#ℂ-complex-numbers)
  - [Set builder notation](#set-builder-notation)
  - [functions](#functions)
    - [dictionaries are functions](#dictionaries-are-functions)
